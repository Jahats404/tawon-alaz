                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="/barang/store" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode" id="exampleInputUsername1" placeholder="Kode">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">Nama Barang</label>
                        <input type="text" class="form-control" name="nama_barang" id="exampleInputEmail1" placeholder="Nama Barang">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Jenis Barang</label>
                        <input type="text" class="form-control" name="jenis_barang" id="exampleInputPassword1" placeholder="Jenis Barang">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Stok</label>
                        <input type="number" class="form-control" name="stok" id="exampleInputConfirmPassword1" placeholder="Stok">
                      </div>
